          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <?php else: ?>
                ...
                <li class="header">You have <?= $countDataMessage; ?> Notif</li>
                        ...
                        <?php foreach ($getDataMessage as $data): ?>
                          <li>
                            <a href="javascript:void(0)">
                              ...
                              <small><i class="fa fa-pencil-o"></i> Edit </small>
                              </h4>
              ...
              <!-- <button data-nama="<?= $data['nama_user']; ?>" class="show_data btn btn-block btn-default btn-xs"> Show </button> -->
            </ul>
          </li>

          <div class="modal fade" id="tes">
